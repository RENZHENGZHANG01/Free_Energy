...
| `data/opt_inp/` | ORCA optimization input files + ORCA-generated intermediate files | `scripts/generate_step1_opt_inp.py`, `scripts/generate_step2_opt_inp_from_xyz.py` | `SD1_step1_pbe_opt.inp`, `SD1_step2_b3lyp_opt.inp`, `SD1_step1_pbe_opt.xyz` (optimized geometry) |
| `data/opt_out/` | ORCA optimization log outputs | ORCA (via `submit_free_energy.csh`) | `SD1_step1_pbe_opt.out`, `SD1_step2_b3lyp_opt.out` |
